...
// console.log(balance.toString().length); string me convert krta hai 
  // console.log(balance.toFixed(4));

 const  num2=123.554;
//  console.log(num2.toPrecision(3)) //next par jump kr jata hai aagr
...
// console.log(Math.round(3.4)); // ye 0.5 ke baad next value par chala jata hai 
